Pod::Spec.new do |s|
  ...
  s.subspec 'Base' do |base|
      ...
      base.resources = 'UFViewComponent/Assets/Base/*.png'
  end
  
  s.subspec 'UI' do |u|
      #包含隐私弹窗，loading等等。。目前只有UI
      u.dependency 'UFViewComponent/Base'
      u.dependency 'SwiftMessages'
      u.source_files = 'UFViewComponent/Classes/Privacy/{*.swift}','UFViewComponent/Classes/CropView/{*.swift}'
      #TODO source区分
      u.resources = 'UFViewComponent/Assets/UI/*.png'
  end
  ...
  s.subspec 'Cutout' do |c|
      ...
      c.dependency 'UFEffectsEngine', '>= 2.4.0'
