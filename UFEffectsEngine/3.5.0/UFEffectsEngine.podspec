Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'git@git.ufotosoft.com:iostools/UFFaceAI.git', :tag => s.version.to_s }
  ...
  s.subspec 'Base' do |base|
      ...
      base.dependency 'UFResourceManager','>= 1.5.0'
      base.dependency 'GPUImage'
      base.dependency 'UFCryptoKit'
      base.dependency 'UFLog','>= 2.1.0'
      base.vendored_frameworks = 'UFEffectsEngine/Classes/*.framework'
  end
  ...
  s.subspec 'Segment' do |e|
     ...
     e.dependency 'UFImageCloudAlgo/Segment','>= 1.5.0'
     e.source_files = 'UFEffectsEngine/Classes/Segment/SourceFile/**/*'
     e.vendored_frameworks = 'UFEffectsEngine/Classes/Segment/*.framework'
     e.xcconfig = { "SWIFT_ACTIVE_COMPILATION_CONDITIONS" => '$(inherited) UFEffect_Segment' }
  end

  #描边
  s.subspec 'Outline' do |f|
     f.dependency 'UFImageCloudAlgo/Segment','>= 1.5.0'
     f.dependency 'UFBase'
  ...
  s.subspec 'Blur' do |h|
    ...
    s.subspec 'Inpaint' do |inpatint|
        inpatint.source_files = 'UFEffectsEngine/Classes/Inpaint/**/*.{h,m,mm,swift}'
        inpatint.dependency 'UFAlgorithm', '>= 1.6.0'
        inpatint.vendored_libraries = 'UFEffectsEngine/Classes/Inpaint/*.a'
    ...
    #天空滤镜
    s.subspec 'SkyFilter' do |sky_filter|
        sky_filter.dependency 'YYModel'
        sky_filter.dependency 'UFRenderFilterSDK'
        sky_filter.dependency 'UFImageTool'
        sky_filter.dependency 'UFEffectsEngine/Base'
        sky_filter.dependency 'UFEffectsEngine/Segment'
        sky_filter.source_files = 'UFEffectsEngine/Classes/SkyFilter/SourceFile/**/*'
        sky_filter.pod_target_xcconfig = {
            'SWIFT_ACTIVE_COMPILATION_CONDITIONS' => '$(inherited) UFEffect_SkyFilter'
        }
    end
    
    s.subspec 'Cartoon3D' do |cartoon|
      cartoon.dependency 'UFEffectsEngine/ArtFilter'
      cartoon.source_files = 'UFEffectsEngine/Classes/Cartoon/**/*'
      cartoon.pod_target_xcconfig = {
        'SWIFT_ACTIVE_COMPILATION_CONDITIONS' => '$(inherited) UFEffect_Cartoon3D'
      }
    end
