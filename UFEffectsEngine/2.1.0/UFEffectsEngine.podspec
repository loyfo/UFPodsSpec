...
#      inpatint.ios.deployment_target = '13.0'
  ...
  #双重曝光
  s.subspec 'ColorSpilt' do |color_spilt|
      color_spilt.dependency 'YYModel'
      color_spilt.dependency 'UFRenderFilterSDK'
      color_spilt.dependency 'GPUImage'
      color_spilt.dependency 'UFEffectsEngine/Base'
      color_spilt.dependency 'UFResourceManager'
      color_spilt.source_files = 'UFEffectsEngine/Classes/ColorSpilt/**/{*.swift}'
      color_spilt.pod_target_xcconfig = {
          'SWIFT_ACTIVE_COMPILATION_CONDITIONS' => '$(inherited) UFEffect_ColorSpilt'
      }
  end
