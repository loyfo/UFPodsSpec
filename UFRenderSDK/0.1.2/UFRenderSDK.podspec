...
Pod::Spec.new do |spec|
  ...
  spec.source_files         = [ 'UFRenderSDK/UFRenderSDK/classes/**/*',
  ...
  spec.public_header_files  = [ 'UFRenderSDK/UFRenderSDK/UFRenderSDK.h',
                                'UFRenderSDK/UFRenderSDK/classes/**/*.h',
                                'UFRenderSDK/UFRenderSDK/libs/**/*.h'
                                ]

  spec.private_header_files = 'UFRenderSDK/UFRenderSDK/libs/**/IOSNativePlayer.hpp'
