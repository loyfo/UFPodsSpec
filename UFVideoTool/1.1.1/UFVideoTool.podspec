...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.subspec 'VideoBase' do |b|
    b.source_files = 'UFVideoTool/Classes/UFVideoBase/**/*'
  end

  s.subspec 'UFVideoDecode' do |audio|
    audio.source_files = 'UFVideoTool/Classes/UFVideoDecode/**/*','UFVideoTool/Classes/UFVideoBase/**/*'
  end

  s.subspec 'UFAudio' do |audio|
    audio.source_files = 'UFVideoTool/Classes/UFAudio/**/*'
  end

  s.subspec 'MediaEdit' do |e|
    e.source_files = 'UFVideoTool/Classes/UFMediaEdit/**/*','UFVideoTool/Classes/UFVideoBase/**/*'
  end
