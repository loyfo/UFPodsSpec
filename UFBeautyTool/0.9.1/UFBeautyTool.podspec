...
Pod::Spec.new do |s|
  ...
  s.subspec 'Static' do |b|
    ...
    b.private_header_files = 'UFBeautyTool/Classes/Common/RenderEngine/include/*'
  ...
  s.subspec 'Buffer' do |c|
    ...
    c.dependency 'UFImageTool/ImageHelper', '~> 1.2.1'
    c.vendored_libraries = 'UFBeautyTool/Frameworks/Buffer/**/*.a','UFBeautyTool/Frameworks/Common/**/*.a'
    c.private_header_files = 'UFBeautyTool/Classes/Common/RenderEngine/include/*'
