...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'git@git.ufotosoft.com:iostools/UFVideoEditTool.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'7
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '760407695@qq.com' => 'chenliu@ufotosoft.com' }
  s.source           = { :git => 'https://git.ufotosoft.com/iostools/UFVideoEditTool.git', :tag => s.version.to_s }
