Pod::Spec.new do |s|
  ...
  s.subspec 'Bokeh' do |g|
     ...
     g.source_files = 'UFEffectEngine/Classes/{*.h,*.m,*.mm,*.swift}', 'UFEffectEngine/Classes/Bokeh/**/{*.h,*.m,*.mm,*.swift}'
  ...
  s.subspec 'Blur' do |h|
      ...
      h.source_files = 'UFEffectEngine/Classes/{*.h,*.m,*.mm,*.swift}', 'UFEffectEngine/Classes/Blur/**/{*.h,*.m,*.mm,*.swift}'
