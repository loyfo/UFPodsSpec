...
Pod::Spec.new do |s|
  ...
  #普通滤镜
    s.subspec 'V1' do |b|
       ...
       b.dependency 'UFLog'
       b.dependency 'UFCodecSDK','>= 2.0.26'
       b.dependency 'UFSegmentationSelfie/SenseMe','>= 1.1.0'
       b.dependency 'UFRenderSDK', '>= 3.6.35'
       ...
       b.pod_target_xcconfig = {
           ...
           'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) UFVideoRender_V1' # OC 宏定义需要这个
       }
    end
    ...
    s.subspec 'V2' do |b|
       ...
       b.pod_target_xcconfig = {
           ...
           'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) UFVideoRender_V2' # OC 宏定义需要这个
       }
    end  
end
