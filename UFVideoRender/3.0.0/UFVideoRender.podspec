...
Pod::Spec.new do |s|
  ...
  #普通滤镜
 s.source_files = 'UFVideoRender/Classes/**/*.{swift,h,m}'
 s.resource = 'UFVideoRender/Assets/**/*'
 s.dependency 'UFSwiftBase','>= 1.8.0'
 s.dependency 'UFResourceManager','>= 2.1.0'
 s.dependency 'UFOpenGLSDK','>= 1.0.8'
 s.dependency 'UFLog'
 s.dependency 'UFCodecSDK','>= 2.0.26'
 s.dependency 'UFSegmentationSelfie/SenseMe','>= 1.1.0'
 s.dependency 'UFRenderSDK', '>= 3.4.34'
 s.dependency 'UFVideoTool'
 s.dependency 'UFAlgorithm', '>= 1.6.0'
 s.dependency 'UFBase','>= 1.1.0'
end
